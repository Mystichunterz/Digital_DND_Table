...
const abilityScoresData = [
    ...
    { icon: Dexterity_Icon, label: "DEX", title: "Dexterity", value: 14, isPrimary: false, isProficient: false, description: "Agility, reflexes, and balance. Affects your effectiveness with ranged and **Finesse** weapons. Also affects your initiative and **Armour Class**.", savingThrows: ["Dexterity, +2"], sources: ["**14** Base"] },
